    ...
    return (
        <>
            <div className="text-center border md:w-1/3 mt-5 rounded-xl mx-auto p-5 shadow-md">
                ...
                <button onClick={(e) => logout(e)} className="bg-primary text-white w-1/2 md:w-1/3 rounded-full py-1 me-2 mt-4 hover:scale-105 hover:shadow-md transition-transform duration-300 ease-in-out">Logout</button>
