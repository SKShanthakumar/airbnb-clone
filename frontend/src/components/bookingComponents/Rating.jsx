...
export default function Rating() {
    ...
    return (
        <div className="flex justify-around items-center border rounded-2xl p-5 my-10" style={{ boxShadow: '0px 0px 10px rgba(0, 0, 0, 0.2)' }}>
            <p className="font-semibold text-2xl">Rate your experience</p>

            <div className="flex">
                <div className="text-yellow-400 cursor-pointer px-1"
                    onClick={(e) => { setRating(1); addRating(e); }}
                ...
                <div className="text-yellow-400 cursor-pointer px-1"
                    onClick={(e) => { setRating(2); addRating(e); }}
                ...
                <div className="text-yellow-400 cursor-pointer px-1"
                    onClick={(e) => { setRating(3); addRating(e); }}
                ...
                <div className="text-yellow-400 cursor-pointer px-1"
                    onClick={(e) => { setRating(4); addRating(e); }}
                ...
                <div className="text-yellow-400 cursor-pointer px-1"
                    onClick={(e) => { setRating(5); addRating(e); }}
